...
class TestProcessingResult:
    ...
    def test_successful_result(self, sample_bookmark, sample_scrape_result, sample_llm_metadata):
...
class TestBookmarkProcessor:
    ...
    async def test_successful_processing_no_cache(self, sample_bookmark, sample_scrape_result,
        ...
        mock_llm_service.title_desc_from_scrape_result.assert_called_once_with(sample_scrape_result)
        mock_cache_manager.store_scrape_result.assert_called_once_with(sample_scrape_result)
        mock_cache_manager.store_llm_metadata.assert_called_once_with(sample_llm_metadata)

    @pytest.mark.asyncio
    async def test_processing_with_cached_data(self, sample_bookmark, sample_scrape_result,
                                              sample_llm_metadata, mock_cache_manager,
                                              mock_scraper, mock_llm_service):
    ...
    @pytest.mark.asyncio
    async def test_scraping_error_handling(self, sample_bookmark, mock_cache_manager,
                                          mock_scraper, mock_llm_service):
    ...
    @pytest.mark.asyncio
    async def test_llm_error_handling(self, sample_bookmark, sample_scrape_result,
                                     mock_cache_manager, mock_scraper, mock_llm_service):
    ...
    @pytest.mark.asyncio
    async def test_force_refresh(self, sample_bookmark, sample_scrape_result, sample_llm_metadata,
                                mock_cache_manager, mock_scraper, mock_llm_service):
    ...
    @pytest.mark.asyncio
    async def test_cache_disabled(self, sample_bookmark, sample_scrape_result, sample_llm_metadata,
                                 mock_cache_manager, mock_scraper, mock_llm_service):
    ...
    @pytest.mark.asyncio
    async def test_process_multiple_bookmarks(self, mock_cache_manager, mock_scraper, mock_llm_service):
    ...
    @pytest.mark.asyncio
    async def test_get_processing_stats(self, mock_cache_manager, mock_scraper, mock_llm_service):
    ...
    @pytest.mark.asyncio
    async def test_get_processing_stats_cache_disabled(self, mock_scraper, mock_llm_service):
...
class TestIntegration:
    ...
    async def test_end_to_end_processing(self):
        ...
        with patch('ombm.pipeline.CacheManager') as mock_cache_class, \
            ...
            mock_scraper.fetch = AsyncMock(return_value=ScrapeResult(
